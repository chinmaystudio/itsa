-- ============================================================================
-- ITSA (Information Technology Students' Association) Database Schema
...
-- ============================================================================
-- 1. Contact Form Submissions (Reviews, Inquiries & Registrations)
-- ============================================================================
CREATE TABLE IF NOT EXISTS contact_submissions (
    ...
    status VARCHAR(50) DEFAULT 'received' CHECK (status IN ('received', 'in_review', 'replied', 'archived')),
...
-- Index for querying submissions by date and status
...
-- ============================================================================
-- 3. Team Members (Faculty, Core, Community Leads, Executives)
-- ============================================================================
CREATE TABLE IF NOT EXISTS members (
    ...
    tier VARCHAR(50) NOT NULL CHECK (tier IN ('faculty', 'core', 'lead', 'executive')),
    email VARCHAR(255),
    linkedin_url TEXT,
    github_url TEXT,
    avatar_url TEXT,
...
-- 1. Contact submissions: allow public anonymous INSERT from the web form
...
-- 2. Contact submissions: allow authenticated users (admin/council) to view/update
...
-- 3. Public read policies for content tables (teams, events, achievements, clubs)
